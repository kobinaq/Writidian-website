...
export const SOCIAL_CLUTTER = [
  ...
  {
    id: "s2",
    line: "Hot take thread you do not need",
    tone: "sans" as const,
    x: 78,
    y: 10,
    mx: 78,
  ...
  {
    id: "s4",
    line: "Watch this before you write",
    tone: "sans" as const,
    x: 84,
    y: 34,
    mx: 82,
  ...
  {
    id: "s5",
    line: "Someone replied to your story",
    tone: "serif" as const,
    x: 48,
    y: 16,
    mx: 48,
  ...
  {
    id: "s8",
    line: "Meeting starts in 5 minutes",
    tone: "sans" as const,
    x: 86,
    y: 70,
    mx: 82,
  ...
  {
    id: "s9",
    line: "Generate a better paragraph",
    tone: "serif" as const,
    x: 34,
    y: 52,
    mx: 36,
  ...
  {
    id: "s10",
    line: "Infinite scroll is calling",
    tone: "sans" as const,
    x: 70,
    y: 44,
    mx: 62,
